...
class MiningTest(BitcoinTestFramework):
    ...
    def test_timewarp(self):
        ...
        assert_greater_than_or_equal(tmpl['curtime'], t + MAX_FUTURE_BLOCK_TIME - MAX_TIMEWARP_TESTNET)
        ...
        bad_block.nTime = t + MAX_FUTURE_BLOCK_TIME - MAX_TIMEWARP_TESTNET - 1
        bad_block.solve()
        assert_raises_rpc_error(-25, 'time-timewarp-attack', lambda: node.submitheader(hexdata=CBlockHeader(bad_block).serialize().hex()))

        bad_block.nTime = t + MAX_FUTURE_BLOCK_TIME - MAX_TIMEWARP_TESTNET
        bad_block.solve()
