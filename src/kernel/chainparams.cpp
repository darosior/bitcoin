...
public:
    CMainParams() {
        ...
        // Deployment of Consensus Cleanup
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].nStartTime = Consensus::BIP9Deployment::NEVER_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].min_activation_height = 0;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        // Deployment of Consensus Cleanup
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CLEANUP].min_activation_height = 0;
