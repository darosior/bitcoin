...
static const unsigned int DEFAULT_BLOCK_MIN_FEERATE = 1000;
...
static const unsigned int DEFAULT_INCREMENTAL_RELAY_FEERATE = 1000;
...
static const unsigned int DUST_RELAY_FEERATE = 3000;
/**
