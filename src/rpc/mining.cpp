...
static UniValue estimatesmartfee(const JSONRPCRequest& request)
{
            ...
            "       \"ECONOMICAL\"\n"
            "       \"CONSERVATIVE\""},
                    {"legacy", RPCArg::Type::BOOL, /* default */ "true", "Return fees per virtual byte instead of weight unit."},
                },
                RPCResult{
            "{\n"
    ...
    if (feeRate != CFeeRate(0)) {
        ...
        if (!request.params[2].isNull() && request.params[2].get_bool()) {
            feerate = feerate * WITNESS_SCALE_FACTOR;
        }
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "util",               "estimatesmartfee",       &estimatesmartfee,       {"conf_target", "estimate_mode", "legacy"} },
