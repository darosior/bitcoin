...
static UniValue getnetworkinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("relayfee",      ValueFromAmount(::minRelayTxFee.GetFeePerK() * WITNESS_SCALE_FACTOR));
    obj.pushKV("incrementalfee", ValueFromAmount(::incrementalRelayFee.GetFeePerK() * WITNESS_SCALE_FACTOR));
