...
struct Ops {
    ...
    static __m256i inline K(uint32_t x) { return _mm256_set1_epi32(x); }

    static __m256i inline Add(__m256i x, __m256i y) { return _mm256_add_epi32(x, y); }
    static __m256i inline Xor(__m256i x, __m256i y) { return _mm256_xor_si256(x, y); }
    static __m256i inline Or(__m256i x, __m256i y) { return _mm256_or_si256(x, y); }
    static __m256i inline And(__m256i x, __m256i y) { return _mm256_and_si256(x, y); }
    static __m256i inline ShR(__m256i x, int n) { return _mm256_srli_epi32(x, n); }
    static __m256i inline ShL(__m256i x, int n) { return _mm256_slli_epi32(x, n); }

    static __m256i inline Read(const unsigned char* chunk, int offset) {
    ...
    static void inline Write(unsigned char* out, int offset, __m256i v) {
