        ...
        return NullUniValue;
            ...
            RPCHelpMan{"settxfee",
                "\nSet the transaction feerate for this wallet. Overrides the global -paytxfee command line parameter.\n",
                {
                    ...
                    {"feerate_weight", RPCArg::Type::BOOL, "false", "Set the transaction feerate in " + CURRENCY_UNIT + "/kWU"},
                },
                RPCResult{
...
static UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("paytxfee", ValueFromAmount(pwallet->m_pay_tx_fee.GetFeePerK() * WITNESS_SCALE_FACTOR));
...
{ //  category              name                                actor (function)                argNames
    ...
    { "wallet",             "settxfee",                         &settxfee,                      {"amount", "feerate_weight"} },
