...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-discardfee=<amt>", strprintf("The fee rate (in %s/kB) that indicates your tolerance for discarding change by adding it to the fee (default: %s). "
                                                              ...
                                                              CURRENCY_UNIT, CFeeRate(DEFAULT_DISCARD_FEERATE).ToString()), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-fallbackfee=<amt>", strprintf("A fee rate (in %s/kB) that will be used when fee estimation has insufficient data. 0 to entirely disable the fallbackfee feature. (default: %s)",
                                                               CURRENCY_UNIT, CFeeRate(DEFAULT_FALLBACK_FEERATE).ToString()), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    ...
    gArgs.AddArg("-mintxfee=<amt>", strprintf("Fees (in %s/kB) smaller than this are considered zero fee for transaction creation (default: %s)",
                                                            CURRENCY_UNIT, CFeeRate(DEFAULT_TRANSACTION_MIN_FEERATE).ToString()), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
    gArgs.AddArg("-paytxfee=<amt>", strprintf("Fee (in %s/kB) to add to transactions you send (default: %s)",
                                                            CURRENCY_UNIT, CFeeRate(DEFAULT_PAY_FEERATE).ToString()), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
