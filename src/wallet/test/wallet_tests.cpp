...
static_assert(DEFAULT_TRANSACTION_MIN_FEERATE >= DEFAULT_MIN_RELAY_FEERATE, "wallet minimum feerate is smaller than default relay feerate");
static_assert(WALLET_INCREMENTAL_RELAY_FEE >= DEFAULT_INCREMENTAL_RELAY_FEERATE, "wallet incremental feerate is smaller than default incremental relay feerate");
